# 📦 CÓDIGO COMPLETO DEL SISTEMA - PARTE 2

## 6️⃣ COMPONENTES UI COMPLETOS
...
async function main() {
  ...
  console.log('👤 Admin user: admin@mdp.com / admin123')
  console.log('👤 Supervisor user: supervisor@mdp.com / supervisor123')
  console.log('👤 Regular user: user@mdp.com / user123')
}
...
Ahora tienes el código completo del Sistema de Inventario MDP. Sigue estos pasos:
